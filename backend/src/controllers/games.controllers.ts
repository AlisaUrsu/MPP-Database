...
export class Controller {
    ...
    public signUp: RequestHandler = async(req, res, next) => {
        ...
        try {
            ...
            const existingUsername = await this.service.getUserByUsername(username);
            ...
            //const newUser = await this.service.addUser(username, passwordHashed, type);
            const newUser = await UserModel.create({username: username, password: passwordHashed, type: type});
    ...
    public login: RequestHandler = async (req, res, next) => {
        ...
        try {
            ...
            if (!passwordMatch) {
                console.log(user);
                throw createHttpError(401, "Invalid credentialsaaa");
            }
